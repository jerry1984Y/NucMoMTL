...
if __name__ == "__main__":
    ...
    global_task = ['TMP', 'CTP', 'CMP', 'UTP','UMP','ATP', 'ADP', 'AMP', 'GDP', 'GTP']
    circle = 5
    ...
    for trains, tests, pl in zip(trainfiles, testfiles, pls):
        ...
        for i in range(circle):
            storeapl = 'AddTest/MTLADD_MTL-207_1521—_7_part_oc_T5_all_' + pl + '_' + str(i) + '.pkl'
            train(storeapl)
        ...
        with open('AddTest/Result_MTLT-207__15217_part_OC_T5_MTL_' + pl + '.txt', 'w') as f:
